...
const studentDB = {
    ...
    "Y25102016": { name: "SONALI PANI", course: "B.Sc.", topics: [16, 3] },
    "Y25102003": { name: "ANANYA GAUTAM", course: "B.Sc.", topics: [3, 10] },
    ...
    "Y25102001": { name: "AANCHAL SHYAMANAND JHA", course: "B.Sc.", topics: [1, 8] },
    ...
    "Y25106042": { name: "VRANDA CHOURASIYA", course: "B.Sc.", topics: [2, 9] },
    "Y25106013": { name: "HARSHITA CHOUBEY", course: "B.Sc.", topics: [13, 0] },
    "Y25102006": { name: "MEGHADRI ROY", course: "B.Sc.", topics: [6, 13] },
    ...
    "Y25109003": { name: "KANAK CHOUKSEY", course: "B.Sc.", topics: [3, 10] },
    "Y25109015": { name: "POONAM DIXIT", course: "B.Sc.", topics: [15, 2] },
    ...
    "Y25102007": { name: "PANISMITA BAG", course: "B.Sc.", topics: [7, 14] },
    ...
    "Y25106002": { name: "AAVANI M", course: "B.Sc.", topics: [2, 9] },
    "Y25109019": { name: "TEJASWANI PATEL", course: "B.Sc.", topics: [19, 6] },
    ...
    "Y25109010": { name: "SNEHA KUMARI", course: "B.Sc.", topics: [10, 17] },
    "Y25105008": { name: "DIVYA PATEL", course: "B.Sc.", topics: [8, 15] },
    "Y25105024": { name: "SAKSHI GAUTAM", course: "B.Sc.", topics: [4, 11] },
    "Y25105016": { name: "NANDINI KURMI", course: "B.Sc.", topics: [16, 3] },
    "Y25106014": { name: "HARSHITA SAHU", course: "B.Sc.", topics: [14, 1] },
    "Y25109012": { name: "KHUSHUBU JAISWAL", course: "B.Sc.", topics: [12, 19] },
    "Y25109021": { name: "SURBHI DUBEY", course: "B.Sc.", topics: [1, 8] },
    "Y25106047": { name: "CATHERIN JOY", course: "B.Sc.", topics: [7, 14] },
    ...
    "Y25106039": { name: "TANISHQ SHARMA", course: "B.Sc.", topics: [19, 6] },
    "Y25106040": { name: "TUSHAR", course: "B.Sc.", topics: [0, 7] },
    "Y25109008": { name: "SAKSHI", course: "B.Sc.", topics: [8, 15] },
    ...
    "Y25106015": { name: "KAIFY YUSUF", course: "B.Sc.", topics: [15, 2] },
    ...
    "Y25105012": { name: "KANCHI SONI", course: "B.Sc.", topics: [12, 19] },
    "Y25106027": { name: "NANDNI SHARMA", course: "B.Sc.", topics: [7, 14] },
    "Y25105020": { name: "PRIYDARSHNI DUBEY", course: "B.Sc.", topics: [0, 7] },
    "Y25109007": { name: "RAGINI BADHOLIYA", course: "B.Sc.", topics: [7, 14] },
    "Y25105009": { name: "GOPAL DINKAR", course: "B.Sc.", topics: [9, 16] },
    "Y25102002": { name: "ADITY KUMARI", course: "B.Sc.", topics: [2, 9] },
    "Y25102018": { name: "TANISHA SHILPI", course: "B.Sc.", topics: [18, 5] },
    ...
    "Y25105018": { name: "PAYAL CHOURASIA", course: "B.Sc.", topics: [18, 5] },
    "Y25106030": { name: "RIKANSHA YASHONA", course: "B.Sc.", topics: [10, 17] },
    "Y25102010": { name: "ROHINI BAIDH", course: "B.Sc.", topics: [10, 17] },
    "Y25106022": { name: "LAVANYA SHARMA", course: "B.Sc.", topics: [2, 9] },
    "Y25106023": { name: "MAHI SONI", course: "B.Sc.", topics: [3, 10] },
    "Y25102013": { name: "SEEMANTNI BISEN", course: "B.Sc.", topics: [13, 0] },
    ...
    "Y25102012": { name: "SATYAM ADIWASHI", course: "B.Sc.", topics: [9, 14] },
    "Y25104079": { name: "SHIVAM JAISWAL", course: "B.Sc.", topics: [4, 10] },
    "Y25106011": { name: "DIVYANSH SURYAVANSHI", course: "B.Sc.", topics: [1, 10] },
    "Y25102017": { name: "SUHANI", course: "B.Sc.", topics: [5, 13] },
    "Y25105019": { name: "POORNIMA DIXIT", course: "B.Sc.", topics: [6, 18] },
